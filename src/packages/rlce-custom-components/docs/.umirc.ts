...
const productPath = `/rlce-custom-components@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('rlce-custom-components', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'rlce-custom-components': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
